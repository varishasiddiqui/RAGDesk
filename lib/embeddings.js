...
// Gemini's embedContent caps out at 100 requests (texts) per batch call.
const MAX_BATCH_SIZE = 100;

/**
 * Embed a batch of document texts for storage.
 * Splits into chunks of MAX_BATCH_SIZE since the Gemini API rejects
 * batches larger than 100 requests at once.
 * @param {string[]} texts
