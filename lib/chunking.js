/**
 * Text chunking — direct port of app/chunking.py.
 *
 * Same algorithm, same defaults (chunk_size=800, overlap=150),
 * same chunk_id format ("{filename}_p{page}_c{index}").
 * This is the heart of the RAG pipeline: long pages are split into
